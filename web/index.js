...
// end include: preamble.js
  ...
  function _wgpuDeviceCreateBindGroup(deviceId, descriptor) {
      ...
      function makeEntry(entryPtr) {
        ...
        if (bufferId) {
          ...
          var size = ((size_high === -1 && size_low === -1) ? undefined :           (assert((size_high >>> 0) < 0x200000), (size_high >>> 0) * 0x100000000 + (size_low >>> 0))
  );
  ...
  function _wgpuQueueWriteBuffer(queueId,
      ...
      var bufferOffset = (assert((bufferOffset_high >>> 0) < 0x200000), (bufferOffset_high >>> 0) * 0x100000000 + (bufferOffset_low >>> 0))
  ;
  ...
  function _wgpuRenderPassEncoderSetIndexBuffer(passId, bufferId, format, offset_low, offset_high, size_low, size_high) {
      ...
      var pass = WebGPU.mgrRenderPassEncoder.get(passId);
      var buffer = WebGPU.mgrBuffer.get(bufferId);
      var offset = (assert((offset_high >>> 0) < 0x200000), (offset_high >>> 0) * 0x100000000 + (offset_low >>> 0))
  ;
      var size = ((size_high === -1 && size_low === -1) ? undefined :           (assert((size_high >>> 0) < 0x200000), (size_high >>> 0) * 0x100000000 + (size_low >>> 0))
  );
